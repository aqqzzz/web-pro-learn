...
![1554976180555](C:\Users\张文玘\AppData\Roaming\Typora\typora-user-images\1554976180555.png)
...
需要同时解释 css中的层叠上下文概念（stacking layer)
...
http://huziketang.mangojuice.top/books/react/lesson41

createStore的时候使用了观察者模式，让所有的组件注册对全局唯一的store的监听
